    ...
    <section className=" flex justify-center w- items-center min-h-screen px-20">
      <article className="relative flex item-center flex-wrap md:flex-nowrap justify-center  max-w-[950px] w-full rounded-[20px] p-4 gap-5 border border-[#262840] ">
        <div className="left hidden md:block">
          <Image src={img} alt="" className=" rounded-[20px]" />
        </div>
        ...
        <div className="right">
          <div className="mb-5">
            <h3 className="text-[40px] font-semibold leading-[50px] mt-5 mb-2">Dui accumsan leo vestibulum ornare</h3>
          ...
          <div className="flex items-center gap-6 mb-8">
              ...
              <div className="bg-linear rounded-[20px] border border-[#262840] p-8 w-[496px] ">
               ...
               <div className="">
                    <span className="text-[#7780A1] text-[12px]">Current price</span>
                    <p className="text-white text-[56px] font-semibold">5.25 <span className=" text-[24px] font-bold">ETH</span></p>
                </div>
                <div className=" ">
                    <p className="text-[#7780A1] text-[12px]">Time left</p>
                    <p className="text-[24px] text-white font-semibold">22:59 min</p>
                    <span className="text-[#7780A1] text-[12px]">(01.01.2022 - 01:40:47)</span>
                </div>
               </div>
               <button className="btn-clr py-[12px] px-[24px] w-full text-white rounded-[14px]">Place a bid</button>
              </div>
              <BidHistoryChart/>
        </div>
      </article>
